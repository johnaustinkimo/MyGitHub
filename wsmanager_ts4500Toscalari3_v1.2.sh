#!/usr/bin/env bash
# wsmanager_ts4500Toscalari3_v1.2.sh
# Version: 1.2 - forward child stdout and stderr to WebSocket console
# websocketd allow-list dispatcher for TS4500 -> NFS -> Scalar i3 operations UI.
# Version 1.1 - Scalar i3 v1.3 + write heartbeat/probe controls
set -uo pipefail
umask 077
...
TS4500_SCRIPT="${TS4500_SCRIPT:-${SCRIPT_DIR}/ts4500_ops_v1.5.sh}"
SCALARI3_SCRIPT="${SCALARI3_SCRIPT:-${SCRIPT_DIR}/scalari3_tape_write_v1.3.sh}"
...
run_cmd(){
    ...
    local payload="" script="" label="" rc=1 volser="" after="" yes="" verify="" keep="" entries="" timeout="" preserve="" heartbeat=""
